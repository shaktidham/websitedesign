            ...
            {loading ? (
                ...
                <div className="flex flex-1 bg-[#ECF0F5]">
                    ...
                    <div className="flex-1 p-6 sm:p-8 bg-white rounded-lg shadow-lg ml-64">
                        ...
                        <h2 className="text-2xl font-semibold text-gray-800 mb-6">Add Bus</h2>
                        ...
                        <div className="bg-white border border-gray-300 p-6 rounded-lg shadow-md">
                            <form className="space-y-6" onSubmit={handleSubmit}>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                    ...
                                    {/* Bus Name */}
                                    <div>
                                        <label htmlFor="Busname" className="block text-gray-700 font-medium">Bus Name</label>
                                        <input
                                            id="Busname"
                                            type="text"
                                            className="w-full px-4 py-2 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                            ...
                                            value={data.Busname}
                                            onChange={(e) =>
                                                setData((prev) => ({ ...prev, Busname: e.target.value }))
                                            }
                                        />
                                    </div>
                                    ...
                                    <div>
                                        <label htmlFor="fromtime" className="block text-gray-700 font-medium">From Time</label>
                                        <input
                                            id="fromtime"
                                            type="time"
                                            className="w-full px-4 py-2 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    ...
                                    <div>
                                        <label htmlFor="totime" className="block text-gray-700 font-medium">To Time</label>
                                        <input
                                            id="totime"
                                            type="time"
                                            className="w-full px-4 py-2 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                ...
                                <div className="flex justify-between">
                                    <Pickuppoint villages={villages} setData={setData} data={data} />
                                    <Droppoint villages={villages} setData={setData}  data={data}/>
                                </div>
