...
function Form() {
    ...
    // Retrieve form data from session storage on component mount
    useEffect(() => {
    ...
    const handleSubmit = useCallback(
        async (e) => {
            ...
            try {
                ...
                // Pass both formData and result to the AvailbleRoutes page
                navigate('/AvailbleRoutes', { state: { formData, result } });
