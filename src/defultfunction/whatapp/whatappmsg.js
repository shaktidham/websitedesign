export const handleSendWhatsApp = (item) => {
  ...
  console.log(item,"ol");
    ...
    // કરો અને બપોર પછી 3:30 વાગ્યા પછી આ લિંક ઉપર
    // ક્લિક કરી તમે બસ નું લાઈવ લોકેશન જોઈ શકશો.
    ...
    // // Optionally reset the form or state values
    // setMsgbox((prev) => !prev);  // Toggle the msgbox state
    // setData({
    //   pickup: "",
    //   price: "",
    //   time: "",
